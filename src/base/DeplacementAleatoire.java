...
public class DeplacementAleatoire implements StrategieDeplacement
{
            ...
            AlienEntity entite)
    {
        ...
        if (entite.isAleatoire == false)
        {
            Random rand = new Random();
            double vitesseAlea = 1+rand.nextDouble();
            entite.setHorizontalMovement(entite.getHorizontalMovement() * vitesseAlea);
            entite.isAleatoire = true;
        }
    }
}
